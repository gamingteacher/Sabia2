    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="p-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-bold text-gray-800 mb-6 text-center">Conheça o sabIA</h2>
          ...
          <div className="overflow-x-auto pb-4">
            <div className="flex gap-6 min-w-max">
              <div 
                ...
                className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-all cursor-pointer border-l-4 border-primary group min-w-[300px] flex-shrink-0"
              >
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-bold text-gray-800 group-hover:text-primary transition-colors">Sobre O SabIA</h3>
                </div>
              ...
              <div 
                ...
                className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-all cursor-pointer border-l-4 border-secondary group min-w-[300px] flex-shrink-0"
              >
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-bold text-gray-800 group-hover:text-primary transition-colors">Como Funciona a Curadoria</h3>
                </div>
                <p className="text-gray-600 text-sm leading-relaxed">
              ...
              >
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-bold text-gray-800 group-hover:text-primary transition-colors">Conheça as Categorias</h3>
                </div>
                <p className="text-gray-600 text-sm leading-relaxed">
              ...
              >
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-bold text-gray-800 group-hover:text-primary transition-colors">Modelo L.I.V.R.E.</h3>
                </div>
                <p className="text-gray-600 text-sm leading-relaxed">
              ...
              >
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-bold text-gray-800 group-hover:text-primary transition-colors">Créditos e Licença</h3>
                </div>
                <p className="text-gray-600 text-sm leading-relaxed">
